...
public class SpendBeforeReimburseHistoryVO implements Serializable{
	...
	public static SpendBeforeReimburseHistoryVO toVO(HistoricProcessInstance hpi, ProcessDefinition pd,
				Map<String, Object> variableMap, String currentTaskName) {
		SpendBeforeReimburseHistoryVO vo = new SpendBeforeReimburseHistoryVO();
