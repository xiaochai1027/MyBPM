...
public class StationManagerEntryModifyRequest extends ReapplyTaskRequest {
	...
	@ProcessVariable(isKeyword=true, isUnique=true, showName="手机号", uniqueScope = ProcessUniqueScope.UNFINISHED)
