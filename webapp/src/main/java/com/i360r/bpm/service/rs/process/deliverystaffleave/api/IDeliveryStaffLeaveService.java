...
public interface IDeliveryStaffLeaveService {

	@GET
	@Path("/detail")
	@Produces(ContentType.APPLICATION_JSON_UTF8)
	public ProcessDetailResponse<DeliveryStaffLeaveDetailVO> getDetail(@QueryParam("processInstanceId") String processInstanceId);
	
	@GET
	@Path("/leaveList")
	@Produces(ContentType.APPLICATION_JSON_UTF8)
	public GetLeaveListResponse getLeaveList(@QueryParam("") GetLeaveListRequest request);
	
	@POST
	@Path("/" + DeliveryStaffLeaveConstants.TASK_CREATE)
	...
	@POST
	@Path("/" + DeliveryStaffLeaveConstants.TASK_STATION_MANAGER_APPROVE)
	@Consumes(ContentType.APPLICATION_JSON)
	@Produces(ContentType.APPLICATION_JSON_UTF8)
	public ServiceResponse stationManagerApprove(ApproveRequest request);
	
	@POST
	@Path("/" + DeliveryStaffLeaveConstants.TASK_DIRECT_MANAGEMENT_AREA_MANAGER_APPROVE)
	@Consumes(ContentType.APPLICATION_JSON_UTF8)
	@Produces(ContentType.APPLICATION_JSON_UTF8)
	public ServiceResponse directManagementAreaManagerApprove(ApproveRequest request);
	
	@POST
	@Path("/" + DeliveryStaffLeaveConstants.TASK_DIRECT_MANAGEMENT_CITY_MANAGER_APPROVE)
	@Consumes(ContentType.APPLICATION_JSON_UTF8)
	@Produces(ContentType.APPLICATION_JSON_UTF8)
	public ServiceResponse directManagementCityManagerApprove(ApproveRequest request);
	
	@POST
	@Path("/" + DeliveryStaffLeaveConstants.TASK_DIRECT_MANAGEMENT_LOGISTICS_DIRECTOR_APPROVE)
	@Consumes(ContentType.APPLICATION_JSON_UTF8)
	@Produces(ContentType.APPLICATION_JSON_UTF8)
