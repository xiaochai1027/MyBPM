...
public class ReservedCashRefundHistoryVO implements Serializable{
	...
	public static ReservedCashRefundHistoryVO toVO(ProcessDefinition pd, HistoricProcessInstance hpi, Map<String, Object> variableMap, String taskName) {
		ReservedCashRefundHistoryVO vo = new ReservedCashRefundHistoryVO();
		...
		BigDecimal amountAfter = amountBefore.subtract(changeAmount);
