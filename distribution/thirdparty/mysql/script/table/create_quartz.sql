...
DROP TABLE IF EXISTS QZ_JOB_LISTENERS;
DROP TABLE IF EXISTS QZ_TRIGGER_LISTENERS;
...
CREATE TABLE QZ_JOB_LISTENERS (
JOB_NAME VARCHAR(191) NOT NULL,
JOB_GROUP VARCHAR(191) NOT NULL,
JOB_LISTENER VARCHAR(191) NOT NULL,
PRIMARY KEY (JOB_NAME,JOB_GROUP,JOB_LISTENER),
INDEX (JOB_NAME, JOB_GROUP),
FOREIGN KEY (JOB_NAME,JOB_GROUP)
REFERENCES QZ_JOB_DETAILS(JOB_NAME,JOB_GROUP))
ENGINE=InnoDB;
...
REFERENCES QZ_TRIGGERS(TRIGGER_NAME,TRIGGER_GROUP))
ENGINE=InnoDB;
...
CREATE TABLE QZ_TRIGGER_LISTENERS (
TRIGGER_NAME VARCHAR(191) NOT NULL,
TRIGGER_GROUP VARCHAR(191) NOT NULL,
TRIGGER_LISTENER VARCHAR(191) NOT NULL,
...
INSERT INTO QZ_LOCKS values('TRIGGER_ACCESS');
INSERT INTO QZ_LOCKS values('JOB_ACCESS');
INSERT INTO QZ_LOCKS values('CALENDAR_ACCESS');
INSERT INTO QZ_LOCKS values('STATE_ACCESS');
INSERT INTO QZ_LOCKS values('MISFIRE_ACCESS');
commit; 
